...
pygame.display.set_caption('ADVENTURE TIME WITH FAIZ')
clock = pygame.time.Clock()
FPS = 30

# background images
# Load and then scale the image to fit the window size
main_menu_bg_original = pygame.image.load('assets/main_menu1.png') 
main_menu_bg = pygame.transform.scale(main_menu_bg_original, SIZE)

bg1 = pygame.image.load('assets/BG11.png')
bg2 = pygame.image.load('assets/BG22.png')
bg = bg1
...
play_btn = Button(play, (128, 64), WIDTH//2 - 64, HEIGHT//2 + 10) 
